...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_axios__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuejs_dialog__ = __webpack_require__(36);
 ...
 */
Vue.component('todo-component', __webpack_require__(38));
...
var update = __webpack_require__(42)("43313538", content, false);
    ...
    methods: {
        ...
        removeTodo: function removeTodo(todo) {
            ...
            this.$dialog.confirm("¿Estás seguro que deseas eliminar este recordatorio?", {
                ...
                _this3.axios.delete('/api/todos/' + todo.id).then(function (response) {
                    dialog.close();
        ...
        toggleDone: function toggleDone(todo) {
            this.axios.put('/api/todos/' + todo.id).then(function (response) {
                if (response.data.rslt) {
                    todo.done = !todo.done;
                }
            });
