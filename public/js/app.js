...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_axios__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuejs_dialog__ = __webpack_require__(37);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_2_vuejs_dialog___default.a);
...
var update = __webpack_require__(43)("43313538", content, false);
...
var TodoItem = __webpack_require__(46);
var TodoInput = __webpack_require__(49);
/**
 * Tips:
    ...
    methods: {
        ...
        removeTodo: function removeTodo(todoId) {
            ...
            this.$dialog.confirm("¿Estás seguro que deseas eliminar este recordatorio?", {
                ...
                _this3.axios.delete('/api/todos/' + todoId).then(function (response) {
                    dialog.close();
        ...
        toggleDone: function toggleDone(todoId) {
            ...
            this.axios.put('/api/todos/' + todoId).then(function (response) {
                if (response.data.rslt) {
